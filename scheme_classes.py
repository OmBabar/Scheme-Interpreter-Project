...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        curr_environment = self
        while curr_environment is not None:
            if symbol in self.bindings:
                return self.bindings[symbol]
            elif not symbol in self.bindings and self.parent:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # Bind each formal parameter to its corresponding argument value in the newly created frame. 
        # #The first symbol in formals should be bound to the first value in vals, and so on.
